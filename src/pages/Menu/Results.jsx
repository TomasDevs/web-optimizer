    ...
    <div className="results-page">
      ...
      <FadeInOnScroll className="section-page">
        ...
        <p className="section-text">
          Stránka prezentuje klíčové výsledky z testování optimalizačních
      ...
      <FadeInOnScroll className="section-page">
        <div className="tabs-content">
          ...
          {activeTab === 1 && (
            <div className="tab-panel">
              ...
              <p className="section-text">
                ...
                , kde LCP prvkem je hlavní hero obrázek. Grafy zobrazují
                porovnání naměřených hodnot LCP pomocí různých nástrojů a z
                různých geografických lokalit.
              </p>
              ...
              <div className="info">
                ...
                <p>
                  ...
                  Web-vitals knihovna nebo Chrome DevTools naměřily rychlejší
                  časy načítání, nástroje testující z geograficky vzdálených
                  lokalit jako WebPageTest ukázaly výrazně pomalejší LCP.
                  Nejzajímavější je, že optimalizace přinesly konzistentní
                  zlepšení ve všech nástrojích, i když s různou mírou
                  efektivity.
                </p>
                <p>
            ...
            <div className="tab-panel">
              ...
              <div className="info">
                ...
                <p>
                  ...
                  rychlosti připojení a poskytuje konzistentní výkon i na
                  pomalých sítích. Tyto výsledky jasně demonstrují důležitost
                  optimalizací pro uživatele s pomalejším připojením.
                </p>
              </div>
            </div>
          )}
          ...
          {activeTab === 4 && (
            <div className="tab-panel">
              ...
              <p className="section-text">
                ...
                CDN poskytovatelů (jsDelivr, cdnjs) a z lokálního hostingu.
                Grafy zobrazují časy prvního načtení (Fetch) a načtení při
                zapnutém cachování. Testováno bylo pro knihovny různých
                velikostí od malých (Lodash) až po extrémně velké (Babylon.js).
              </p>
          ...
          {activeTab === 5 && (
            <div className="tab-panel">
              ...
              <p className="section-text">
                ...
                druhém volání. Grafy ukazují vliv cachování na rychlost
                odpovědi, míru komprese dat a celkové zlepšení při opakovaném
                volání. Rozšířený test zahrnuje 8 různých API s různými
                charakteristikami.
              </p>
          ...
          {activeTab === 6 && (
            <div className="tab-panel">
              <h2 className="section-subtitle">
                Specifické testy optimalizace
              </h2>
              <p className="section-text">
                Výsledky testů zaměřených na konkrétní optimalizace pro INP a
                CLS metriky. Grafy ukazují porovnání neoptimalizované a
                optimalizované verze pro různé běžné scénáře webu jako
                zpracování formulářů, JavaScriptových výpočtů, práce s reklamami
                nebo dynamickým obsahem.
              </p>
              ...
              <div className="info">
                ...
                <p>
                  Výsledky testů jasně ukazují, že způsob implementace
                  konkrétních prvků webu má zásadní vliv na Core Web Vitals
                  metriky, a tím i na uživatelský zážitek.
                </p>
              </div>
            </div>
          )}
