  ...
  return (
    <div className="page cls-detail-page">
      ...
      <p className="section-text">
        Metrika <strong>Cumulative Layout Shift (CLS)</strong> sleduje vizuální
        stabilitu stránky během načítání. Pokud se prvky na stránce pohybují
        nebo posouvají, může to uživatele zmást a vést ke špatnému uživatelskému
        zážitku. Podle doporučení Googlu by hodnota CLS měla být nižší než{" "}
        <strong>0,1</strong>.
      </p>
      ...
      <div className="tip-block">
        <h3>Rezervace prostoru pro obrázky</h3>
        <p>
          Pokud obrázky nemají definovanou šířku a výšku, může to způsobit
          posuny layoutu během načítání. Prohlížeč totiž neví, kolik prostoru má
          pro obrázek rezervovat.
        </p>
        <p>
          <strong>Řešení:</strong> Vždy definujte atributy <code>width</code> a
          <code>height</code> pro každý obrázek, případně použijte CSS pravidlo
...
.class {
    aspect-ratio: auto 16/9;
        ...
        <p>
          <strong>Tip:</strong> Pokud používáte dynamické obrázky, zajistěte, že
          server vrátí správné rozměry.
        </p>
      </div>

      <div className="tip-block">
        <h3>Správné načítání fontů</h3>
        <p>
          Webové fonty mohou způsobit „flash“ efekt, kdy se text nejprve zobrazí
          ve výchozím fontu a poté se přepne na cílový font.
        </p>
        <p>
          <strong>Řešení:</strong> Použijte atribut{" "}
          <code>font-display: swap</code>v definici fontu, aby byl text zobrazen
          co nejdříve.
        </p>
        <pre>
          {`@font-face {
  ...
  font-display: swap;
      ...
      <div className="tip-block">
        <h3>Odezva serveru a dynamické prvky</h3>
        <p>
          Dynamicky načítané prvky, jako jsou produkty v e-shopu nebo komentáře,
          mohou způsobit vizuální posuny během načítání, protože nejsou ihned
          dostupné.
        </p>
        <p>
          <strong>Řešení:</strong> Rezervujte místo pro tyto prvky ještě před
          tím, než se načtou data. Toho lze dosáhnout pomocí "placeholderů" nebo
          skeletonů, které vyplní prostor, dokud není k dispozici skutečný
          obsah.
        </p>
...
.skeleton {
    ...
    background: #f0f0f0;
        ...
        <p>
          Tímto způsobem zajistíte stabilitu layoutu a předejdete posunům prvků,
          jakmile se obsah načte.
        </p>
      </div>
